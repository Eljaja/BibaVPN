...
/** @param {{ cfg: import('../vpnTypes').SavedConfig, onSave: (c: import('../vpnTypes').SavedConfig) => Promise<void>, onBack: () => void }} props */
export function ProfilesScreen({ cfg, onSave, onBack }) {
