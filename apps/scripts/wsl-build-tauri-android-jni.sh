...
OUT="$ROOT/apps/bibavpn-desktop/src-tauri/gen/android/app/src/main/jniLibs"

if [ ! -d "$ROOT/apps/bibavpn-desktop/src-tauri/gen/android/app" ]; then
  echo "Нет gen/android — сначала: cd apps/bibavpn-desktop && npm run android:bootstrap" >&2
  exit 1
fi
