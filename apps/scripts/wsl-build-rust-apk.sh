...
if command -v go >/dev/null 2>&1; then
  ...
  echo "Skip: no Go — place apps/android/app/libs/tun2socks.aar (see apps/scripts/build-tun2socks-gomobile.sh) or Gradle will use the Maven AAR without 16 KB pages."
fi

echo "Building libbibavpn_jni.so (4 ABIs) ..."
OUT="$REPO_ROOT/apps/android/app/src/main/jniLibs"
