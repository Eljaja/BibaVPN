...
const MESSAGES = {
  ru: {
    ...
    btn_save: "Сохранить",
    btn_clear: "Скрыть",
    settings_save_failed: "Настройки не сохранены: {error}",
    ...
    android_split_pick: "Добавить приложение с телефона",
    android_split_added: "Дополнительные приложения (обход VPN)",
    android_manual_packages_label: "Редактировать список вручную",
    android_manual_packages_hint:
      "Одно имя пакета на строку; добавляется к пресетам и к выбранным приложениям выше.",
    connect_stat_latency: "пинг",
    connect_stat_uptime: "аптайм",
    connect_stat_down: "вниз",
  },
  en: {
    app_title: "BibaVPN",
    ...
    btn_save: "Save",
    btn_clear: "Dismiss",
    settings_save_failed: "Settings not saved: {error}",
    ...
    android_split_pick: "Pick app from phone",
    android_split_added: "Extra apps (bypass VPN)",
    android_manual_packages_label: "Edit list manually",
    android_manual_packages_hint:
      "One package name per line; merged with presets and apps picked above.",
    connect_stat_latency: "rtt",
    connect_stat_uptime: "uptime",
    connect_stat_down: "down",
  },
};
